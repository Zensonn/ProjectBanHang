            ...
            <div class="content-block">
                <div class="inner">
                    <div class="post-thumbnail">
                        <img src='<c:url value="/templates/user/images/blog/blog-single.jpg"/>' alt="blog Images">
                    </div>
                    <!-- End .thumbnail -->
                </div>
            </div>
                    ...
                    <div class="post-details wp-block-columns alignwide has-2-columns">
                        <div class="wp-block-column">
                            <figure class="wp-block-image is-resized">
                                <img class="img-fluid" src='<c:url value="/templates/user/images/blog/blog-01.png"/>' alt="blog image">
                            </figure>
                        ...
                        <div class="axil-single-widget mt--40">
                            ...
                            $150
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        <h6 class="title"><a href='<c:url value="blog-details.jsp"/>'>Addidas Shoes</a></h6>
                                        <div class="product-meta-content">
                                                    <span class="woocommerce-Price-amount amount">
                            <del>$300</del>
                            $200
                ...
                <div class="content-blog">
                    <div class="inner">
                        <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                            ...
                            <div class="thumbnail">
                                <a href='<c:url value="blog-details.jsp"/>'>
                                    <img src='<c:url value="/templates/user/images/blog/blog-07.png"/>' alt="Blog Images">
                                </a>
                            </div>
                            <!-- End Single Thumb  -->
                        </div>
                        <div class="content">
                            <h5 class="title"><a href='<c:url value="blog-details.jsp"/>'>With an Irreverent Twist, AMBUSH® Highlights Converse's Outdoor Heritage</a></h5>
                            <div class="axil-post-meta">
                                <div class="post-author-avatar">
                                    <img src='<c:url value="/templates/user/images/blog/author-image-1.png"/>' alt="Author Images">
                                </div>
                ...
                <div class="content-blog">
                    <div class="inner">
                        <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                            ...
                            <div class="thumbnail">
                                <a href='<c:url value="blog-details.jsp"/>'>
                                    <img src='<c:url value="/templates/user/images/blog/blog-08.png"/>' alt="Blog Images">
                                </a>
                            </div>
                            <!-- End Single Thumb  -->
                        </div>
                        <div class="content">
                            <h5 class="title"><a href='<c:url value="blog-details.jsp"/>'>UCLA Athletics Reaches Multi-Year
                ...
                <div class="content-blog">
                    <div class="inner">
                        <div class="axil-gallery-activation axil-slick-arrow arrow-between-side">
                            ...
                            <div class="thumbnail">
                                <a href='<c:url value="blog-details.jsp"/>'>
                                    <img src='<c:url value="/templates/user/images/blog/blog-09.png"/>' alt="Blog Images">
                                </a>
                            </div>
                            <!-- End Single Thumb  -->
                        </div>
                        <div class="content">
                            <h5 class="title"><a href='<c:url value="blog-details.jsp"/>'>An oral history of the AIM away
