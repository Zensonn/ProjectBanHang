            ...
            <div class="new-arrivals-product-activation slick-layout-wrapper--15 axil-slick-arrow  arrow-top-slide">
                <div class="slick-single-layout" style="height: inherit">
                    <div class="axil-product product-style-four">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/electric/product-02.png"/>' alt="Product Images">
                            </a>
                            ...
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                                    <li class="select-option"><a href='<c:url value="/views/user/cart.jsp"/>'>Add to Cart</a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Level 20 RGB Cherry</a></h5>
                ...
                <div class="slick-single-layout" style="height: inherit">
                    <div class="axil-product product-style-four">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-19.png"/>' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Sky Blue T-shirt</a></h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout" style="height: inherit">
                    <div class="axil-product product-style-four">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-6.png"/>' alt="Product Images">
                            </a>
                            <div class="label-block label-right">
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Women's Stylish Hat</a></h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout" style="height: inherit">
                    <div class="axil-product product-style-four">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/jewellery/product-4.png"/>' alt="Product Images">
                            </a>
                            <div class="label-block label-right">
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Diamond Ring</a></h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout" style="height: inherit">
                    <div class="axil-product product-style-four">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/furniture/product-5.png"/>' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Neue Sofa Chair</a></h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout" style="height: inherit">
                    <div class="axil-product product-style-four">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/electric/product-04.png"/>' alt="Product Images">
                            </a>
                            <div class="label-block label-right">
                                <div class="product-badget">50% OFF</div>
                            </div>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>3D™ wireless headset</a></h5>
                                <div class="product-price-variant">
                                    <span class="price old-price">$30</span>
                                    <span class="price current-price">$24</span>
                                </div>
                ...
                <div class="slick-single-layout" style="height: inherit">
                    <div class="axil-product product-style-four">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/furniture/product-4.png"/>' alt="Product Images">
                            </a>
                            <div class="label-block label-right">
                                <div class="product-badget">30% OFF</div>
                            </div>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Men's Winter Jacket</a></h5>
                                <div class="product-price-variant">
                                    <span class="price old-price">$50</span>
                                    <span class="price current-price">$40</span>
                                </div>
                ...
                <div class="slick-single-layout" style="height: inherit">
                    <div class="axil-product product-style-four">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-3.png"/>' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Leather Hand Bag</a></h5>
                                <div class="product-price-variant">
                                    <span class="price old-price">$60</span>
                                    <span class="price current-price">$50</span>
                                </div>
            ...
            <div class="new-arrivals-product-activation-2 slick-layout-wrapper--15 axil-slick-arrow arrow-top-slide product-slide-mobile">
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/electric/product-05.png" />' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                ...
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Bass Meets Clarity</a></h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-15.png"/>' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                ...
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Nike Shoe</a></h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/furniture/product-24.png" />' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                ...
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Stylish Men's Shoe</a></h5>
                                <div class="product-price-variant">
                                    <span class="price current-price">$40</span>
                                </div>
                            </div>
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/jewellery/product-10.png" />' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                ...
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Diamond Bracelet</a></h5>
                                <div class="product-price-variant">
                                    <span class="price current-price">$40</span>
                                </div>
                            </div>
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="400" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-25.png" />' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                ...
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Smart Watch</a></h5>
                                <div class="product-price-variant">
                                    <span class="price current-price">$30</span>
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-10.png" />' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                ...
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Women's Cosmetics</a></h5>
                                <div class="product-price-variant">
                                    <span class="price current-price">$80</span>
                                </div>
                            </div>
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/jewellery/product-12.png" />' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                        ...
                        <div class="product-content">
                            <div class="inner">
                                ...
                                <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Denim Black Jacket</a></h5>
                                <div class="product-price-variant">
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="400" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-13.png" />' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                ...
                <div class="slick-single-layout">
                    <div class="axil-product product-style-three">
                        <div class="thumbnail">
                            <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/jewellery/product-14.png" />' alt="Product Images">
                            </a>
                            <div class="product-hover-action">
                                <ul class="cart-action">
                                    <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
            ...
            <div class="row">
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="poster-countdown-thumbnail">
                        <img src='<c:url value="/templates/user/images/product/poster/poster-03.png" />' alt="Poster Product">
    ...
    <div class="container">
                ...
                <div class="row row--15">
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800" class="main-img" src='<c:url value="/templates/user/images/product/electric/product-01.png" />' alt="Product Images">
                                    <img class="hover-img" src='<c:url value="/templates/user/images/product/electric/product-08.png" />' alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% Off</div>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Yantiti Leather & Canvas Bags</a></h5>
                                    <div class="product-price-variant">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800" src='<c:url value="/templates/user/images/product/fashion/product-15.png" />' alt="Product Images">
                                    <img class="hover-img" src='<c:url value="/templates/user/images/product/fashion/product-24.png" />' alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="quickview"><a href="#" data-bs-toggle="modal" data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                                        <li class="select-option"><a href='<c:url value="/views/user/product-details.jsp"/>'>Select Option</a></li>
                                        <li class="wishlist"><a href='<c:url value="/views/user/wishlist.jsp"/>'><i class="far fa-heart"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800" src='<c:url value="/templates/user/images/product/furniture/product-1.png" />' alt="Product Images">
                                    <img class="hover-img" src='<c:url value="/templates/user/images/product/furniture/product-2.png" />' alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% Off</div>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Stylish Wooden Chair</a></h5>
                                    <div class="product-price-variant">
                                        <span class="price current-price">$29.99</span>
                                        <span class="price old-price">$49.99</span>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800" src='<c:url value="/templates/user/images/product/jewellery/product-3.png" />' alt="Product Images">
                                    <img class="hover-img" src='<c:url value="/templates/user/images/product/jewellery/product-4.png" />' alt="Product Images">
                                </a>
                                <div class="product-hover-action">
                                    <ul class="cart-action">
                                        <li class="quickview"><a href="#" data-bs-toggle="modal" data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Womens Ring</a></h5>
                                    <div class="product-price-variant">
                                        <span class="price current-price">$29.99</span>
                                        <span class="price old-price">$49.99</span>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800" src='<c:url value="/templates/user/images/product/fashion/product-10.png" />' alt="Product Images">
                                    <img class="hover-img" src='<c:url value="/templates/user/images/product/fashion/product-12.png" />' alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% Off</div>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Women's Cosmetis</a></h5>
                                    <div class="product-price-variant">
                                        <span class="price current-price">$29.99</span>
                                        <span class="price old-price">$49.99</span>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800" src='<c:url value="/templates/user/images/product/fashion/product-16.png" />' alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% Off</div>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Full Sleev T-shirt</a></h5>
                                    <div class="product-price-variant">
                                        <span class="price current-price">$29.99</span>
                                        <span class="price old-price">$49.99</span>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="800" src='<c:url value="/templates/user/images/product/electric/product-07.png" />' alt="Product Images">
                                    <img class="hover-img" src='<c:url value="/templates/user/images/product/electric/product-08.png" />' alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% Off</div>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    ...
                                    <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Zone Headphone</a></h5>
                                    <div class="product-price-variant">
                                        <span class="price current-price">$29.99</span>
                                        <span class="price old-price">$49.99</span>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800" src='<c:url value="/templates/user/images/product/furniture/product-15.png" />' alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% Off</div>
                                </div>
                            ...
                            <div class="product-content">
                                <div class="inner">
                                    <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Wooden Box Waredrove</a></h5>
                                    <div class="product-price-variant">
                                        <span class="price current-price">$29.99</span>
                                        <span class="price old-price">$49.99</span>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                        <div class="axil-product product-style-one">
                            <div class="thumbnail">
                                <a href='<c:url value="/views/user/product-details.jsp"/>'>
                                    <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800" src='<c:url value="/templates/user/images/product/fashion/product-10.png" />' alt="Product Images">
                                    <img class="hover-img" src='<c:url value="/templates/user/images/product/fashion/product-10.png" />' alt="Product Images">
                                </a>
                                <div class="label-block label-right">
                                    <div class="product-badget">20% Off</div>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-12 text-center mt--20 mt_sm--0">
                <a href='<c:url value="/views/user/shop.jsp"/>' class="axil-btn btn-bg-lighter btn-load-more">View All Products</a>
            </div>
        </div>
        ...
        <div class="new-arrivals-product-activation slick-layout-wrapper--30 axil-slick-arrow  arrow-top-slide">
            <div class="slick-single-layout">
                <div class="axil-product product-style-two has-color-pick">
                    <div class="thumbnail">
                        <a href='<c:url value="/views/user/product-details.jsp"/>'>
                            <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-14.png" />' alt="Product Images">
                        </a>
                        <div class="label-block label-right">
                            <div class="product-badget">50% OFF</div>
                        </div>
                    ...
                    <div class="product-content">
                        <div class="inner">
                            ...
                            <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Full A-Line Dress</a></h5>
                            <div class="product-price-variant">
                                <span class="price old-price">$50</span>
            ...
            <div class="slick-single-layout">
                <div class="axil-product product-style-two has-color-pick">
                    <div class="thumbnail">
                        <a href='<c:url value="/views/user/product-details.jsp"/>'>
                            <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-4.png" />' alt="Product Images">
                        </a>
                        <div class="label-block label-right">
                            <div class="product-badget">30% OFF</div>
                        </div>
                    ...
                    <div class="product-content">
                        <div class="inner">
                            ...
                            <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Guys Bomber Jacket</a></h5>
                            <div class="product-price-variant">
                                <span class="price old-price">$30</span>
                                <span class="price current-price">$20</span>
                            </div>
            ...
            <div class="slick-single-layout">
                <div class="axil-product product-style-two has-color-pick">
                    <div class="thumbnail">
                        <a href='<c:url value="/views/user/product-details.jsp"/>'>
                            <img data-sal="fade" data-sal-delay="400" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-5.png" />' alt="Product Images">
                        </a>
                        <div class="label-block label-right">
                            <div class="product-badget">50% OFF</div>
                        </div>
            ...
            <div class="slick-single-layout">
                <div class="axil-product product-style-two has-color-pick">
                    <div class="thumbnail">
                        <a href='<c:url value="/views/user/product-details.jsp"/>'>
                            <img data-sal="fade" data-sal-delay="100" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-10.png" />' alt="Product Images">
                        </a>
                        <div class="label-block label-right">
                    ...
                    <div class="product-content">
                        <div class="inner">
                            ...
                            <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Men's Tshirt</a></h5>
                            <div class="product-price-variant">
                                <span class="price old-price">$40</span>
                                <span class="price current-price">$30</span>
                            </div>
            ...
            <div class="slick-single-layout">
                <div class="axil-product product-style-two has-color-pick">
                    <div class="thumbnail">
                        <a href='<c:url value="/views/user/product-details.jsp"/>'>
                            <img data-sal="fade" data-sal-delay="200" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-11.png" />' alt="Product Images">
                        </a>
                        <div class="label-block label-right">
                    ...
                    <div class="product-content">
                        <div class="inner">
                            ...
                            <h5 class="title"><a href='<c:url value="/views/user/product-details.jsp"/>'>Leather Jacket</a></h5>
                            <div class="product-price-variant">
                                <span class="price old-price">$50</span>
                                <span class="price current-price">$40</span>
                            </div>
            ...
            <div class="slick-single-layout">
                <div class="axil-product product-style-two has-color-pick">
                    <div class="thumbnail">
                        <a href='<c:url value="/views/user/product-details.jsp"/>'>
                            <img data-sal="fade" data-sal-delay="300" data-sal-duration="1500" src='<c:url value="/templates/user/images/product/fashion/product-12.png" />' alt="Product Images">
                        </a>
                        <div class="label-block label-right">
                            <div class="product-badget">15% OFF</div>
                        </div>
