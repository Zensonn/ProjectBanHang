        ...
        <div class="tile">
            <div class="tile-body">
                <div class="row element-button">
                    <div class="col-sm-2">
                        <a class="btn btn-add btn-sm" href='<c:url value="/admin/style/new"/>' title="Thêm"><i
                                class="fas fa-plus"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6">
                        <div class="text-sm-right">
                            <form action="<c:url value="/admin/style"/>" method="get">
                ...
                <table class="table table-hover table-light table-bordered">
                    ...
                    <c:forEach var="style" items="${styles}">
                        <tr>
                            ...
                            <td>${style.name}</td>
                            <td>
                                <a type="button" class="btn btn-sm edit" href='<c:url value="/admin/style/edit?id=${style.id}"/>'>
                                    <i class="fas fa-edit mr-1"></i> Sửa
                                </a>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a type="button" class="btn btn-sm trash" href='<c:url value="/admin/style/delete?id=${style.id}"/>'>
